...
namespace ahorcado
{
    class ahorcado
    {
            ...
            while (jugar == true)
            {
                ...
                while (intentos <= 6)
                {
                    ...
                    for (int i = 0; i < espaciosEnBlanco.Length; i++)
                    {
                        ...
                        {
                            Console.WriteLine("Esa letra ya existe escriba otra letra");
                            Console.ReadKey();
                            contador++;
                        }
                        else
                ...
                {
                    Console.WriteLine("Perdiste se te acabaron los intentos la palabra era {0} quieres juegar de nuevo : S /  N", palabra);
                    volverjugar = Console.ReadLine();
                    if (volverjugar == "n") jugar = false;
        ...
        {
            string[] palabras = new string[15] { "Hamburgesa", "Taco", "Carro", "Uno", "Planeta", "Ajolote", "Perro", "Gato", "Pollo", "Moto", "Mesa", "Cien", "Diez", "Dinero", "Araña" };
